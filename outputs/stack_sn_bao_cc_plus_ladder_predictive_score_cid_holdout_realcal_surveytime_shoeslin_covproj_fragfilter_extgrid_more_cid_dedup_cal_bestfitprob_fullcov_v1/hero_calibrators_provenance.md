...
- Source run: `/home/primary/Hubble-Systematics-Review-Chain/outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cid_holdout_realcal_surveytime_shoeslin_covproj_fragfilter_extgrid_more_cid_dedup_cal_bestfitprob_fullcov_v1`
...
- Holdout Δlogp: +0.438 (n_test=1)
- Rows in ladder table: 1
- Surveys present: `CSP`

| IDSURVEY | survey | cal? | HF? | zHD | m_b_corr | σ_diag | MU_SH0ES | σ(MU) | CEPH_DIST | PKMJD | PKMJDERR | MWEBV | HOST_LOGMASS | FITPROB |
|---:|---|:---:|:---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | `CSP` | Y | N | 0.01028 | 14.02580 | 0.24648 | 33.27880 | 0.24795 | 33.24500 | 53833.90 | 0.0720 | 0.02286 | 10.501 | 0.9971 |
