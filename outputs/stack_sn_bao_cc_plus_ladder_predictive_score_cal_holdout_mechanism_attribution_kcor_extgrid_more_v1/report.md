...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_mechanism_attribution_kcor_extgrid_more_v1`
...
- +biascor_m_b_linear_cal: mean_logp=5.30, Δlogp_vs_base=0.09

- +c_linear_cal: mean_logp=4.92, Δlogp_vs_base=-0.30

- +c_x1_biascor_cal: mean_logp=7.10, Δlogp_vs_base=1.89

- +cal_offset: mean_logp=9.94, Δlogp_vs_base=4.72

- +cal_offset_plus_c_x1_biascor_cal: mean_logp=11.49, Δlogp_vs_base=6.28

- +cal_offset_plus_survey_pkmjd_bins_plus_c_x1_biascor_cal: mean_logp=11.49, Δlogp_vs_base=6.27

- +survey_pkmjd_bins: mean_logp=5.29, Δlogp_vs_base=0.07

- +survey_pkmjd_bins_plus_c_x1_biascor_cal: mean_logp=7.14, Δlogp_vs_base=1.92

- +x1_linear_cal: mean_logp=6.75, Δlogp_vs_base=1.54
