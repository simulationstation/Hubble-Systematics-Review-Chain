...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_mechanism_attribution_calibcov_bounded_extgrid_more_fullcov_v1`
...
- +cal_offset: mean_logp=9.58, Δlogp_vs_base=2.90

- +cal_offset_plus_cal_time_bins: mean_logp=10.24, Δlogp_vs_base=3.56

- +cal_offset_plus_pkmjderr_plus_cal_time_bins: mean_logp=11.31, Δlogp_vs_base=4.63

- +cal_time_bins: mean_logp=7.81, Δlogp_vs_base=1.13

- +pkmjderr_linear_cal: mean_logp=10.03, Δlogp_vs_base=3.35

- baseline: mean_logp=6.68, Δlogp_vs_base=0.00
