...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_covproj_hostmass_scope_v1`
...
- +host_mass_step_all: mean_logp=7.65, Δlogp_vs_base=1.07

- +host_mass_step_cal_only: mean_logp=10.08, Δlogp_vs_base=3.50

- +host_mass_step_hf_only: mean_logp=6.58, Δlogp_vs_base=0.00

- baseline_fields: mean_logp=6.58, Δlogp_vs_base=0.00
