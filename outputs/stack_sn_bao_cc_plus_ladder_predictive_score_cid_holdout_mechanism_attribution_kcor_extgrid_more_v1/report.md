...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cid_holdout_mechanism_attribution_kcor_extgrid_more_v1`
...
- +c_x1_biascor_cal: mean_logp=0.55, Δlogp_vs_base=0.11

- +cal_offset: mean_logp=0.76, Δlogp_vs_base=0.32

- +survey_pkmjd_bins: mean_logp=0.44, Δlogp_vs_base=0.01

- +x1_linear_cal: mean_logp=0.53, Δlogp_vs_base=0.10
