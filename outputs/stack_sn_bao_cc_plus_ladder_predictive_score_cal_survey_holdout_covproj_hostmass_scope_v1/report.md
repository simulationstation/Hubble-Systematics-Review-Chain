...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_survey_holdout_covproj_hostmass_scope_v1`
...
- +host_mass_step_all: mean_logp=2.21, Δlogp_vs_base=0.38

- +host_mass_step_cal_only: mean_logp=3.05, Δlogp_vs_base=1.23

- +host_mass_step_hf_only: mean_logp=1.82, Δlogp_vs_base=0.00

- baseline_fields: mean_logp=1.82, Δlogp_vs_base=0.00
