...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cid_holdout_constrained_decomp_kcor_calhf_shoeslin_extgrid_more_v1`
...
- +bounded_fields_plus_metadata: mean_logp=0.81, Δlogp_vs_base=0.37

- +cal_offset_bounded: mean_logp=0.72, Δlogp_vs_base=0.28

- +cal_offset_bounded_plus_bounded_fields_plus_metadata: mean_logp=0.82, Δlogp_vs_base=0.38
