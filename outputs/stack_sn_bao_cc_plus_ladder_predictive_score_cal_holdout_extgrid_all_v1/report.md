...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_extgrid_all_v1`
...
- +cal_offset: mean_logp=9.70, Δlogp_vs_base=5.23

- +cal_time_bins: mean_logp=9.26, Δlogp_vs_base=4.78

- +pkmjderr_linear_cal: mean_logp=8.73, Δlogp_vs_base=4.25
