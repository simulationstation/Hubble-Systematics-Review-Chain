...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cid_holdout_covproj_term_ablations_v1`
...
- +fields+biascor_m_b: mean_logp=0.48, Δlogp_vs_base=0.04

- +fields+c_linear: mean_logp=0.45, Δlogp_vs_base=0.01

- +fields+host_mass_step: mean_logp=0.73, Δlogp_vs_base=0.29

- +fields+mwebv: mean_logp=0.46, Δlogp_vs_base=0.02

- +fields+pkmjd_err: mean_logp=0.70, Δlogp_vs_base=0.26

- +fields+x1_linear: mean_logp=0.56, Δlogp_vs_base=0.13
