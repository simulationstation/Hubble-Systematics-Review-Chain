...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_surveytime_calibcov_extgrid_all_v1`
...
- +cal_offset_calibcov_surveytime: mean_logp=8.33, Δlogp_vs_base=3.85

- +cal_offset_free: mean_logp=9.70, Δlogp_vs_base=5.23

- +cal_offset_plus_survey_pkmjd_bins_calibcov_surveytime: mean_logp=8.35, Δlogp_vs_base=3.87

- +survey_pkmjd_bins_calibcov_surveytime: mean_logp=4.99, Δlogp_vs_base=0.51

- +survey_pkmjd_bins_free: mean_logp=5.54, Δlogp_vs_base=1.06
