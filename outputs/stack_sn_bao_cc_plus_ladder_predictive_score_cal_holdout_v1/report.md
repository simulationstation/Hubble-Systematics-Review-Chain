...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_v1`
...
- +cal_offset: mean_logp=9.70, Δlogp_vs_base=5.74

- +cal_survey_offsets_min4: mean_logp=5.09, Δlogp_vs_base=1.13

- +cal_time_bins: mean_logp=8.91, Δlogp_vs_base=4.95
