...
Run dir: `outputs/stack_sn_bao_cc_plus_ladder_predictive_score_cal_holdout_fragilistic_shoes_v1`
...
- +cal_offset_fragilistic_survey_priors: mean_logp=9.86, Δlogp_vs_base=5.90

- +cal_offset_fragilistic_survey_priors_shoes_prior: mean_logp=8.91, Δlogp_vs_base=4.95

- +cal_offset_free: mean_logp=9.70, Δlogp_vs_base=5.74

- baseline: mean_logp=3.96, Δlogp_vs_base=0.00

- baseline_fragilistic_survey_priors: mean_logp=3.87, Δlogp_vs_base=-0.09
